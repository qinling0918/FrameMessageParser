...
public class Frame698 implements Cloneable, IFrame {
    ...
    public static String REGEX_SINGLE_GROUP = "^[0-9]+$";
    public static String REGEX_MATCH = "^[A-Aa-a0-9]+$";
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            linkDataStr = "";
            //linkData = APDU.get().getRequestNormal(new PIID(0),new OAD());
            linkData = null;
        ...
        public Builder setLinkData(APDU linkData) {
        ...
        /**
         * 获取 链路数据层分帧时 分帧格式域 + APDU 的数据
         *
         * @param linkDataString APDU 字符串
         * @return 分帧格式域 + APDU
         * 分帧格式域 2字节 16bit位
    ...
    public static final class Parser {
        ...
        private int checkFrame698(String frame698Str) {
            if (TextUtils.isEmpty(frame698Str) || !NumberConvert.isHexStr(frame698Str)) return -1;
            int len = frame698Str.length();


            if (len < 24 || len % 2 != 0) return -2;
            ...
            if (!NumberConvert.getFcsOrHcs(frame_head).equalsIgnoreCase(hcs)) return -5;
        ...
        private String getAddressFirstByteStr(String frame698Str) {
            String firstAddressByteStr = frame698Str.substring(8, 10);
            return firstAddressByteStr;
        }
        ...
        /*public APDUParser getLinkData() {
            return APDU.parse(getLinkDataStr());
        }*/
